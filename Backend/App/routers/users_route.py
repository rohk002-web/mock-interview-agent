...
from App.service.users_service import create_user , list_users , login_user
...
async def list_all_users(db: Session= Depends(get_db), current_user=Depends(get_current_user)):
